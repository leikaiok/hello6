...
/* BEGIN Add AT command timeout value by yangyao in 20220308 */
#define GENERAL_AT_TIMEOUT_MSEC        (15 * 1000)
/* End Add AT command timeout value by yangyao in 20220308 */
...
typedef enum {
    ...
    SINGLELINE_NO_PREFIX,  /* a single intermediate response starting with no prefix */
